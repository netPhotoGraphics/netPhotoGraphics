...
/* extensions/galleryArticles.php */
gettext('New album: %1$s');
gettext('New image: [%2$s]%1$s');

/* extensions/paged_thumbs_nav.php */
gettext('« prev thumbs');
gettext('next thumbs »');

/* extensions/register_user.php */
