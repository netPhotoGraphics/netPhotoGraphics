...
<h1>
	<?php
	printf(gettext('%1$s plugins'), isset($classXlate[$plugin_default]) ? ucfirst($classXlate[$plugin_default]) : $plugin_default);
	?>
</h1>
...
<div class="tabbox">
	...
	printf(gettext('There are no %1$s plugins'), $plugin_default);
}
echo "\n" . '</div>'; //content
printAdminFooter();
echo "\n" . '</div>'; //main
