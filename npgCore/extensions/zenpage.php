...
require_once(CORE_PLUGIN_SERVERPATH . 'zenpage/classes.php');
require_once(CORE_PLUGIN_SERVERPATH . 'zenpage/class-news.php');
require_once(CORE_PLUGIN_SERVERPATH . 'zenpage/class-page.php');
require_once(CORE_PLUGIN_SERVERPATH . 'zenpage/class-category.php');
