						...
						<form class="dirtylistening" onReset="setClean('form_editcomment');" id="form_editcomment" action="?action=savecomment" method="post" autocomplete="off">
							...
							<div class="commentformedit_fields">
								...
								if (getOption('comment_form_addresses')) {
									...
									<input type="text" name="0-comment_form_street" id="comment_form_street" class="inputbox" size="40" value="<?php if (isset($commentarr['street'])) echo $commentarr['street']; ?>">
									<label for="comment_form_city"><?php echo gettext('City:'); ?></label>
									<input type="text" name="0-comment_form_city" id="comment_form_city" class="inputbox" size="40" value="<?php if (isset($commentarr['city'])) echo $commentarr['city']; ?>">
									<label for="comment_form_state"><?php echo gettext('State:'); ?></label>
									<input type="text" name="0-comment_form_state" id="comment_form_state" class="inputbox" size="40" value="<?php if (isset($commentarr['state'])) echo $commentarr['state']; ?>">
									<label for="comment_form_country"><?php echo gettext('Country:'); ?></label>
									<input type="text" name="0-comment_form_country" id="comment_form_country" class="inputbox" size="40" value="<?php if (isset($commentarr['country'])) echo $commentarr['country']; ?>">
									<label for="comment_form_postal"><?php echo gettext('Postal code:'); ?></label>
									<input type="text" name="0-comment_form_postal" id="comment_form_postal" class="inputbox" size="40" value="<?php if (isset($commentarr['postal'])) echo $commentarr['postal']; ?>">
									<?php
								}
								?>
