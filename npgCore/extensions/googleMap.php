...
$plugin_notice = sprintf(gettext('<strong>Note</strong>: Google does place limits on the use of its <a href="%s"><em>Maps API</em></a>. Please review these to be sure your site is in compliance.'), 'https://mapsplatform.googleblog.com/2011/10/introduction-of-usage-limits-to-maps-api.html');
