...
if (defined('SETUP_PLUGIN')) { //	gettext debugging aid
	...
	$plugin_notice = gettext("<strong>IMPORTANT</strong>: Only one multimedia extension plugin can be enabled at the time and the class-video plugin must be enabled, too.") . '<br /><br />' . gettext("Please see <a href='https://videojs.org'>VideoJS.org</a> for more info about the player and its license.");
