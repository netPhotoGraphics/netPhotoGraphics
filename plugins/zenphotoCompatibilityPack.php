...
$legacyReplacements = array(
		...
		'extensionEnabled\([\'"]zenpage[\'"]\)' => "class_exists('CMS')",
		...
		'ZP_SEARCH_LINKED' => 'SEARCH_LINKED',
		'ZP_ALBUM_LINKED' => 'ALBUM_LINKED',
		'ZP_IMAGE_LINKED' => 'IMAGE_LINKED',
		'ZP_ALBUM' => 'NPG_ALBUM',
		'ZP_IMAGE' => 'NPG_IMAGE',
		'ZP_COMMENT' => 'NPG_COMMENT',
		'ZP_SEARCH' => 'NPG_SEARCH',
		'ZP_ZENPAGE_NEWS_PAGE' => 'ZENPAGE_NEWS_PAGE',
		...
		'gettext_th\((["\'])((?:\\1|(?:(?!\1)).)*)(\1),.*\)' => 'gettext($1$2$1)',
		'ngettext_th\((["\'])((?:\\1|(?:(?!\1)).)*)(\1),.*\)' => 'ngettext($1$2$1)',
		'gettext_pl\((["\'])((?:\\1|(?:(?!\1)).)*)(\1),.*\)' => 'gettext($1$2$1)',
		'ngettext_pl\((["\'])((?:\\1|(?:(?!\1)).)*)(\1),.*\)' => 'ngettext($1$2$1)',
