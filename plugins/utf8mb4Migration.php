...
$plugin_disable = zpFunctions::pluginDisable(array(array(version_compare(MySQL_VERSION, '5.5.3', '<'), gettext('MySQL version 5.5.3 or greater is required to support trans-BMP character encodings.')), array(@$_conf_vars['UTF-8'] == 'utf8mb4', gettext('<em>utf8mb4</em> migration is complete. '))));
