	...
	function getOptionsSupported() {
		...
		return array(
				...
				gettext('Use isotope') => array(
						...
						'<p class="notebox">' .
						gettext('<strong>Notes:</strong> This album layout does not manage sub-albums (in that case, only pictures of the album are shown and you cant not access on sub-albums).') . '<br />' .
