				...
				<?php if ((getOption('RSS_album_image')) || (getOption('RSS_articles')) || (getOption('RSS_article_comments')) || (getOption('RSS_comments'))) { ?>
					...
					<div id="subscribeextrashow">
						<ul>
							...
							<?php if (getOption('RSS_album_image')) { ?><li><?php printRSSLink('AlbumsRSS', '', gettext('Albums'), '', false); ?></li><?php } ?>
							<?php if (($zenpage) && ($zpmas_usenews)) { ?>
									<?php if (getOption('RSS_articles')) { ?><li><?php printRSSLink('News', '', '', NEWS_LABEL, '', false); ?></li><?php } ?>
								<?php if (getOption('RSS_article_comments')) { ?><li><?php printRSSLink('Comments-all', '', '', gettext('Comments'), '', false); ?></li><?php } ?>
							<?php } else { ?>
									<?php if (getOption('RSS_comments')) { ?><li><?php printRSSLink('Comments', '', gettext('Comments'), '', false); ?></li><?php } ?>
								<?php } ?>
						</ul>
					</div>
					<?php
