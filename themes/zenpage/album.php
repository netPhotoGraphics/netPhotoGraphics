		...
		<div id="main">
			...
			<div id="header">
				...
				if (getOption('Allow_search')) {
					...
					printSearchForm(NULL, 'search', gettext('Search album'), gettext('Search'), NULL, NULL, $album_list);
				}
				?>
			</div>
				...
				<div id="content-left">
					...
					<div id="albums">
						<?php while (next_album()): ?>
							<div class="album">
								<div class="thumb">
									<a href="<?php echo html_encode(getAlbumURL()); ?>" title="<?php echo gettext('View album:'); ?> <?php printBareAlbumTitle(); ?>"><?php printCustomAlbumThumbImage(getBareAlbumTitle(), array('width' => 95, 'height' => 95, 'cw' => 95, 'ch' => 95)); ?></a>
								</div>
								<div class="albumdesc">
