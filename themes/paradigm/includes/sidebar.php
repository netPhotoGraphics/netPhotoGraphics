<aside class="col-sm-3 hidden-xs"	id="sidebar">
	...
	<?php if (function_exists("printAlbumMenu") && (($_gallery_page == 'image.php') || ($_gallery_page == 'album.php') || ($_gallery_page == 'index.php') || ($_gallery_page == 'gallery.php'))) { ?>
	...
	<?php
	if (function_exists("printAllNewsCategories") && ($_gallery_page == 'news.php')) {
		if (hasNews()) {
			?>
			<div class="panel panel-default" id="nav-local">
...
<?php if (function_exists("printPageMenu") && ($_gallery_page == 'pages.php')) { ?>
		<div class="panel panel-default" id="nav-local">
...
<?php if ((getAllTagsUnique(NULL, 1, true)) && ($_gallery_page == 'search.php')) { ?>
...
<?php if (getcodeblock(1, $_gallery) != '') { ?>
		<hr/>
		<div class="well">
			<?php
			printcodeblock(1, $_gallery);
			?>
		</div>
<?php } ?>


<?php if (getcodeblock(2, $_gallery) != '') { ?>
		<hr/>
		<div class="well">
			<?php
			printcodeblock(2, $_gallery);
			?>
		</div>
<?php } ?>
