		...
		<div>
			<label>
				...
				<?php if (getOption('comment_form_anon') && !$disabled['anon']) { ?>
					(<input type="checkbox" name="anon" value="1"<?php if ($stored['anon'])
...
<?php } ?>
	<button class="pushbutton buttons<?php echo $class; ?>"<?php echo $buttonExtra; ?>><?php echo gettext('Add Comment'); ?></button>
</form>
