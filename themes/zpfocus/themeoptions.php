...
class ThemeOptions {
	...
	function getOptionsSupported() {
		return array(
				...
				gettext('Show Credit') => array('order' => 22, 'key' => 'zpfocus_show_credit', 'type' => OPTION_TYPE_CHECKBOX, 'desc' => gettext('Check to display the "Powered by" link in the footer.')),
