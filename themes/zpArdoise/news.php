...
if ($_zenpage_enabled) {
	...
	<div id="headline-news">
				...
				<div class="nav-img clearfix">
					<ul class="clearfix">
						<?php if (getPrevNewsURL()) { ?>
							<li><a href="<?php $article_url = getPrevNewsURL();
				echo $article_url['link'];
							?>" title="<?php echo $article_url['title']; ?>">&laquo; <?php echo gettext('newer'); ?></a></li>
						<?php } else { ?>
							<li class="disabledlink"><span>&laquo; <?php echo gettext('newer'); ?></span></li>
						<?php } ?>
									 <?php if (getNextNewsURL()) { ?>
							<li><a href="<?php $article_url = getNextNewsURL();
										 echo $article_url['link'];
										 ?>" title="<?php echo $article_url['title']; ?>"><?php echo gettext('older'); ?> &raquo;</a></li>
						<?php } else { ?>
		...
		<?php } ?>
			...
			<?php printAllNewsCategories(gettext('All'), true, 'news-cat-list', 'news-cat-active'); ?>
			</div>
	<?php } ?>
