...
class ThemeOptions {
	...
	function getOptionsSupported() {
		return array(
				...
				gettext('Thumb Size') => array(
						'key' => 'zpskel_thumbsize',
				...
				gettext('Debug User Agent') => array(
						'key' => 'zpskel_debuguser',
						'type' => OPTION_TYPE_CHECKBOX,
						'order' => 1,
						'desc' => gettext("Check to display user information in the footer for debugging mobile displays.")
				),
				gettext('Disable Plugin Warning') => array(
						'key' => 'zpskel_disablewarning',
						'type' => OPTION_TYPE_CHECKBOX,
						'order' => 0,
				...
				gettext('Popup (PrettyPhoto) Target') => array(
						'key' => 'zpskel_pptarget',
						'type' => OPTION_TYPE_RADIO,
						'order' => 2,
				...
				gettext('Custom CSS') => array('order' => 9, 'key' => 'zpskel_customcss',
