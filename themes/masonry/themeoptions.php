...
class ThemeOptions {
	...
	function getOptionsSupported() {
		return array(
				...
				gettext('General Thumb Sizes') => array(
						'key' => 'zpmas_thumbsize',
						'type' => OPTION_TYPE_CUSTOM,
						'order' => 2,
				...
				gettext('Crop Album Thumbs to Landscape Orientation?') => array(
						'key' => 'zpmas_thumbcrop',
						'type' => OPTION_TYPE_CHECKBOX,
						'order' => 3,
						'desc' => gettext('Check to crop the album thumbs to a more landscape orientation.')
				),
				gettext('Show Image Title on Album Pages?') => array(
						'key' => 'zpmas_imagetitle',
						'type' => OPTION_TYPE_CHECKBOX,
						'order' => 4,
				...
				gettext('Fix the sidebar\'s position?') => array(
						'key' => 'zpmas_fixsidebar',
						'type' => OPTION_TYPE_CHECKBOX,
						'order' => 6,
				...
				gettext('Logo Height') => array(
						'key' => 'zpmas_logoheight',
				...
				gettext('Colorbox Target Sized Image in Galleriffic') => array(
						'key' => 'zpmas_cbtarget',
						'type' => OPTION_TYPE_CHECKBOX,
						'order' => 15,
				...
				gettext('Frontpage Slideshow?') => array(
						'key' => 'zpmas_ss',
						'type' => OPTION_TYPE_CHECKBOX,
						'order' => 16,
				...
				gettext('Custom CSS') => array('order' => 9, 'key' => 'zpmas_customcss',
