...
<html xmlns="http://www.w3.org/1999/xhtml"<?php i18n::htmlLanguageCode(); ?>>
	<head>
		...
		<?php scriptLoader(CORE_PLUGIN_SERVERPATH . 'colorbox_js/jquery.colorbox-min.js'); ?>

		<?php
		if ($zpmas_ss) {
			scriptLoader(__DIR__ . '/js/jquery.cycle.all.js');
		}
		scriptLoader(CORE_PLUGIN_SERVERPATH . 'colorbox_js/themes/' . $zpmas_cbstyle . '/colorbox.css');
		?>
