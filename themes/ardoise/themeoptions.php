	...
	function getOptionsSupported() {
		return array(
				gettext('Use this file as logo') => array('order' => 0, 'key' => 'use_image_logo_filename',
						...
						'multilingual' => 0,
						'desc' => gettext('Image file for the logo area: enter the full filename (including extension) of the image file located in themes/ardoise/images/ (banniere1.jpg for example).')
				),
				...
				gettext('Color') => array('order' => 3, 'key' => 'color_style',
						'type' => OPTION_TYPE_CUSTOM,
						'desc' => gettext('Choose the color of links: choose Default to use the default color of Dark or Light style and choose Custom to use a custom value. You can customize these values by editing the file theme/ardoise/css/custom.css.')
				),
