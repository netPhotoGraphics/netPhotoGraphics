	...
	function getOptionsSupported() {
		...
		$options = array(
				gettext('ZenFluid color') => array(
						...
						'desc' => gettext("Select the colorscheme.")
				),
				...
				gettext('Description justification') => array(
						...
						'buttons' => $positions,
						'desc' => gettext('Enter the default justification for the description text (Override individual descriptions in admin panel text editor).')
				),
