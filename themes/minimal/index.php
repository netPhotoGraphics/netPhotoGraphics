...
<div id="content" class="home-page">
	<div id="full-image">
		...
		switch (getOption('zpmin_homeoption')) {
			case "album-latest":
				$zpmin_albumorimage = 'album';
				$zpmin_functionoption = 'latest';
				break;
			case "album-latestupdated":
				$zpmin_albumorimage = 'album';
				$zpmin_functionoption = 'latestupdated';
				break;
			...
			case "image-latest-date":
				$zpmin_albumorimage = 'image';
				$zpmin_functionoption = 'latest-date';
				break;
			case "image-latest-mtime":
				$zpmin_albumorimage = 'image';
				$zpmin_functionoption = 'latest-mtime';
				break;
			case "image-popular":
				$zpmin_albumorimage = 'image';
				$zpmin_functionoption = 'popular';
				break;
