...
<div id="sidemenu">
	...
	if (($zpmin_menu) && (function_exists('printCustomMenu'))) {
		...
		<ul id="nav">
			...
			<li <?php if ($_gallery_page == "archive.php") { ?>class="active" <?php } ?>><a href="<?php echo getCustomPageURL('archive'); ?>" title="<?php echo gettext('Archive View'); ?>"><?php echo gettext('Archive'); ?></a></li>
			...
			<?php if (!npg_loggedin() && function_exists('printRegistrationForm')) { ?>
				<li <?php if ($_gallery_page == "register.php") { ?>class="active" <?php } ?>><a href="<?php echo getCustomPageURL('register'); ?>" title="<?php echo gettext('Register'); ?>"><?php echo gettext('Register'); ?></a></li>
			<?php } ?>
			<?php
			if (function_exists("printUserLogin_out")) {
				...
				<?php } else { ?>
					<li <?php if ($_gallery_page == "login.php") { ?>class="active" <?php } ?>><a href="<?php echo getCustomPageURL('login'); ?>" title="<?php echo gettext('Login'); ?>"><?php echo gettext('Login'); ?></a></li>
					<?php } ?>
				<?php } ?>
		</ul>
	<?php } ?>
