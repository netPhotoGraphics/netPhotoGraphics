...
function printItemsListTable($item, $toodeep) {
	...
	<div class="page-list_row">
		...
		<div class="page-list_iconwrapper">
			...
			<div class="page-list_icon">
				<a href="javascript:deleteMenuItem('<?php echo html_encode($item['id']); ?>','<?php echo html_encode(sprintf(gettext('Ok to delete %s? This cannot be undone.'), get_language_string($array['name']))); ?>');" >
