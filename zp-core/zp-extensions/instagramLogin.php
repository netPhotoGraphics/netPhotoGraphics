...
/**
 *
 * The plugin provides login via a Instagram OAuth protocol.
 *
 *
 ...
 * points to <var>%FULLWEBPATH%/%CORE_PATH%/%PLUGIN_PATH%/instagramLogin/instagram-auth.php</var>
 *
 ...
 * from the user's Instagram ID. If this <i>user ID</i> does not exist as a site user,
