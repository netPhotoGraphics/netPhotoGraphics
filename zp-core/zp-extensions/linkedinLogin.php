 ...
 * points to <var>%FULLWEBPATH%/%CORE_PATH%/%PLUGIN_PATH%/linkedinLogin/linkedin.php</var>
 *
...
npgFilters::register('alt_login_handler', 'linkedinLogin::alt_login_handler');
npgFilters::register('edit_admin_custom', 'linkedinLogin::edit_admin');
